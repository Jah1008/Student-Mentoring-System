...
if (isset($_POST['submit'])) {
 ...
 $project_id= $_POST['project_id'];
  ...
  $result1= "INSERT INTO project( `sem`, `ssn`,`project_id`,`date_`,`title`,`group_num`,`status`,`guide`) 
  VALUES ('$sem','$ssn','$project_id','$date_','$title','$group_num','$status','$guide')";
  try {
    ...
    if ($result1) {
      ...
      header('location: project.php?action=add-new');
      exit;
...
if (isset($_POST['retrieve'])) {
    ...
    if (empty( $course_info)) {
      $_SESSION['success_msg'] = "PLease check Student   '$ssn_to_retrieve'  of  sem  '$sem_to_retrieve' with project id  '$date_to_retrieve' is unavailable !!";
