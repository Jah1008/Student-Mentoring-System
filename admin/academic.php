...
if (isset($_POST['submit'])) {
  ...
  $result1=  "INSERT INTO academic ( `sem`, `ssn`,`date_`,`gpa`,`credits_com`,`credits_rem`) 
  VALUES ('$sem','$ssn','$date_','$gpa','$credits_com','$credits_rem')";
  try {
    ...
    if ($result1) {
      ...
      header('location: academic.php?action=add-new');
      exit;
