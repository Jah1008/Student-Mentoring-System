...
if (isset($_POST['submit'])) {
  ...
  $result1="INSERT INTO health ( `sem`, `ssn`,`date_`,`issue`,`plan`,`progress`,`height`,`weight`) 
  VALUES ('$sem','$ssn','$date_','$issue','$plan','$progress','$height','$weight')";
  ...
  try {
    ...
    if ($result1) {
      ...
      header('location: health.php?action=add-new');
      exit;
