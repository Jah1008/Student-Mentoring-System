...
if (isset($_POST['submit'])) {
  ...
  $result1=  "INSERT INTO career ( `sem`, `ssn`,`date_`,`intern`,`plan`,`resume`,`job`) 
  VALUES ('$sem','$ssn','$date_','$intern','$plan','$resume','$job')";
  try {
    ...
    if ($result1) {
      ...
      header('location: career.php?action=add-new');
      exit;
...
if (isset($_POST['retrieve'])) {
    ...
    if (empty( $course_info)) {
      $_SESSION['success_msg'] = "PLease check Student   '$ssn_to_retrieve'  of  sem  '$sem_to_retrieve' is invalid !!";
