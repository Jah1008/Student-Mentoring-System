...
if (isset($_POST['submit'])) {
  ...
  $result1=  "INSERT INTO dept (`dept_id`, `dept_name`, `head`) VALUES ('$dept_id', '$dept_name', '$head')";
  ...
  try {
    ...
    if ($result1) {
      ...
      header('location: dept.php?action=add-new');
      exit;
...
if (isset($_POST['retrieve'])) {
  ...
  if (empty($dept_info)) {
    $_SESSION['success_msg'] = "PLease check department id '$dept_id_to_retrieve' is invalid !!";
        ...
        <div class="card-body">
          ...
          <form action="" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <input type="text" name="head" id="duration" class="form-control" placeholder="Head of Department" required>
            </div>
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class form-group">
                  ...
                  <input type="text" class="form-control" id="dept_id_to_retrieve" placeholder="Department ID"
                    name="dept_id_to_retrieve">
                </div>
              </div>
            </div>
          </fieldset>
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="ssn_to_delete" placeholder="Department Id"
                    name="ssn_to_delete">
                </div>
              </div>
            </div>
