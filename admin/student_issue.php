...
if (isset($_POST['submit'])) {
  ...
  $result1= "INSERT INTO issue ( `sem`, `ssn`,`date_`,`time_`,`issues`,`solution_provided`,`advice_given`) 
  VALUES ('$sem','$ssn','$date_','$time_','$issues','$solution_provided','$advice_given')";
  try {
    ...
    if ($result1) {
      ...
      header('location:  student_issue.php?action=add-new');
      exit;
    ...
    if ($e->getCode() === 1452  || $e->getCode() === 1062 ) {
        // MySQL error code 1452 corresponds to a foreign skey constraint violation
      ...
      <div class="card">
        ...
        <!-- ============================================??????????????????????????????????????????????????........... -->
          ...
          <form action="" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
              <label for="duration">Feedback</label>
              <input type="text" name="ad" id="duration" class="form-control" placeholder="Feedback"
                required>
